...
class IngresoController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($buscar==''){
            ...
            'ingresos.condicion','proveedores.nombre','users.usuario')
    ...
    public function obtenerDetalles(Request $request){
        ...
        ->select('detalle_ingresos.cantidad','detalle_ingresos.precio','detalle_ingresos.preciov','articulos.nombre as articulo','articulos.imagen as imagen')
