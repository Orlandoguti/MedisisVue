                                    ...
                                    <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        ...
                                        <td>
                                            ...
                                            <i class="icon-eye"></i>
                                                ...
                                                <template v-if="ingreso.condicion">
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <div class="col-md-3">
                                ...
                                <input disabled type="text" class="form-control" v-model="impuesto">
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
					 ...
					 <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td><img class = "img-square" :src="'/img/articulos/' + detalle.imagen" width="70" height="70"></td>
                                            ...
                                            <td>
                                              ...
                                              <td>
                                                  {{detalle.preciov=parseFloat(detalle.precio*0.2) + parseFloat(detalle.precio)}}
                                             </td>
                                            <td>
                                                {{detalle.precio*detalle.cantidad}}
                                            </td>

                                        <tr style="background-color: rgb(236 110 110 / 69%);color: honeydew;">
                                            <td></td>
                                            <td></td>
    ...
    export default {
        ...
        methods : {
            ...
            listarArticulo (page,buscar,criterio){
                let me=this;
                var url= '/articulo/listarArticulo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
