...
<html>
    ...
    <style>
        ...
        #total{
            background-color: rgb(236 110 110 / 69%);
            color: honeydew;
        }
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo-hosp.jfif" alt="CompartiendoCodigo" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Hospital Modelo Boliviano Japones</b><br>La Paz, Bolivia<br>Telefono:(+591)2204252<br>Email: HospitalModeloBolivianoJapones@gmail.com
                </p>
            </div>
            <div id="fact">
